 ...
 *
 */
public class FocusSmallStraightPolicy extends Policy<YahtzeeState, YahtzeeAction>
{
	private final Map<YahtzeeDiceState, YahtzeeAction> actions;
	private YahtzeeDiceState s = null;
	
	public FocusSmallStraightPolicy( final Map<YahtzeeDiceState, YahtzeeAction> actions )
	{
	...
	{
		return "FocusSmallStraightPolicy";
	}
