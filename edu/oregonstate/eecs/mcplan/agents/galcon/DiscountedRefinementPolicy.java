	...
	implements AnytimePolicy<S, A>
{
	...
	public static void main( final String[] args ) throws FileNotFoundException
	{
		...
		final CoarseSimulation<FastGalconState, FastGalconEvent> coarse_sim
		...
		> agent0
			= new DiscountedRefinementPolicy<
				FastGalconState, DurativeUndoableAction<FastGalconState, FastGalconEvent>>(
					params.ir_max_depth, params.ir_horizon, params.discount, coarse_sim, cgen.create(), visitor,
		...
		> runner
			= new SimultaneousMoveRunner<FastGalconState,
										 DurativeUndoableAction<FastGalconState, FastGalconEvent>>(
				coarse_sim, agents, params.T, params.max_time );
